...
echo "<h1>Room ". $_GET['Ext']." ".$Title8." For ". $_GET['Name']."</h1>" ;
	...
	$query = "SELECT calldate, dst, billsec FROM `cdr` WHERE dstchannel IS NOT NULL AND (dcontext = 'from-internal' OR dcontext = '" . $custchan . "' )  AND (lastapp = 'Dial' OR lastapp = 'ResetCDR') AND calldate BETWEEN '" . $_GET['Checkin'] . "' AND '" . $_GET['Checkout'] ."' AND channel LIKE '%/" . $_GET['Ext'] ."-%'";
	...
	echo "<TR><TD><FONT face=verdana,sans-serif>" . "" . "</TD><TD>"  . "</TD><TD>" . $SecLab33 . "</TD><TD>" . $total . "</TD></TR>\n" ;
        echo "<TR><TD><FONT face=verdana,sans-serif>" . $SecLab34 . $currency."</TD><TD>"  . "</TD><TD>" . $SecLab32 . "</TD><TD>" . ceil($total / 100 * (100 + $vat)) . "</TD></TR>\n" ;
...
?>
<p>Click below to print the call records.</p>
<p><input type="button" onclick="printDiv('Content')" value="PRINT" /></p>
